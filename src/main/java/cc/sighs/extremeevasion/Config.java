...
public final class Config {
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_BULLET_TIME_IN_MULTIPLAYER = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue BULLET_TIME_EXCEPT_PLAYER = BUILDER
            .comment(
